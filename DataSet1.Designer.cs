...
namespace adminpage.DataSet1TableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Categories] WHERE (([cat_id] = @Original_cat_id))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Categories] SET [name] = @name WHERE (([cat_id] = @Original_cat_id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, cat_id FROM Categories WHERE (name = @name)";
        ...
        public virtual int Fill(DataSet1.CategoriesDataTable dataTable, string name) {
        ...
        public virtual DataSet1.CategoriesDataTable GetData(string name) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
